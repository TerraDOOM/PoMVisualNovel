...
init -1 python hide:
    ...
    config.window_title = u"PoMvisualnovel"

    # These control the name and version of the game, that are reported
    # with tracebacks and other debugging logs.
    config.name = "PoMvisualnovel"
    config.version = "0.0"
...
python early:
    config.save_directory = "PoMvisualnovel-1552138325"
...
init -1 python hide:
    ...
    build.name = "PoM dating sim"

    build.executable = "pom_dating_sim"
...
init python:
    ...
    build.directory_name = "PoMvisualnovel-1.0"

    ## The name that's uses for executables - the program that users will run
    ## to start the game. For example, if this is 'mygame', then on Windows,
    ## users can click 'mygame.exe' to start the game.
    build.executable_name = "PoMvisualnovel"
    ...
    build.name = "PoM dating sim"
    build.executable_name = "pom_dating_sim"
